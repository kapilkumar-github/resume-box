...
import { SignInActionBox, SignInContentBox, SignInWrapper } from './signin.styled';
  ...
  return (
    <SignInWrapper >
      <SignInActionBox>
        ...
        <Box>
          Don't have an account yet? <Link href={getAbsoluteURL(PAGE_PATH.SIGN_UP, '/auth')}>Sign Up</Link>
        </Box>
      </SignInActionBox>
      <SignInContentBox>Show Content Here!!</SignInContentBox>
    </SignInWrapper>
  )
}
